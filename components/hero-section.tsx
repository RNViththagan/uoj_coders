...
export const HeroSection = ({}: Props) => {
  return (
    <div className="h-[36rem] lg:h-[40rem] xl:h-[42rem] 2xl:h-[53rem] w-full bg-neutral-950 relative flex flex-col items-center justify-center antialiased overflow-hidden">
      <div className="w-2xl p-4 flex flex-col items-center gap-y-4 -mt-40 lg:-mt-20">
        <div className="w-full flex flex-col justify-center items-center font-varino relative z-10  text-white text-center font-bold">
          <p className="text-6xl md:text-[7rem] lg:text-9xl 2xl:text-[9rem] font-telemarines -mb-4 md:-mb-7 lg:-mb-5">UOJ</p>
          <p className="text-[2.1rem] md:text-[3.75rem] lg:text-7xl 2xl:text-[5rem]">CODERS</p>
        </div>
